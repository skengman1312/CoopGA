...
if __name__ == '__main__':
    ...
    chart_0 = ChartModule([{"Label": "Mean food", "Color": "Black"}], data_collector_name='datacollector',
    ...
    server = ModularServer(FoodModel,
                           ...
                           "Food Model",
                           {"N": UserSettableParameter("slider", "Creature number", 5, 0, 200, 1),
                            "nf": UserSettableParameter("slider", "Food number", 5, 0, 200, 1),
